...
export default class AtomVelocityValidateView {
  ...
  wordwrap( str, width, brk, cut ) {
   ...
   getRepoPathFromConfig(){
     var v = atom.config.get('velocity-validate.RepoPath');
     console.log('getRepoPathFromConfig:' + v)
     return v;
   }

   getExternalJarListFromConfig(){
     var v = atom.config.get('velocity-validate.ExternalJarList');
  ...
  constructor(serializedState) {
    ...
    //this.subscriptions.add(atom.config.onDidChange('atom-clock.velocityValidatorJarPath', () => {
    ...
    this.jarInput.onchange = e => {
         ...
         console.log(file);
         setVelocityJarConfigValue(file.path);
...
*/
  ...
  runCompile(){
    ...
    useExternalJars = this.getExternalJarListFromConfig();
...
setVelocityJarConfigValue(t){
    ...
    atom.config.set('atom-clock.velocityValidatorJarPath',t);
    this.toggleJarConfigView();
  }

  setVelocityJarFromConfig(){
    this.velocityValidatorJarPath = this.getVelocityJarPathFromConfig(); //atom.config.get('atom-clock.velocityValidatorJarPath')
  }
