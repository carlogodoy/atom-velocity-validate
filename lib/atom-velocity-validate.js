...
export default {
  ...
  config: {
  velocityValidatorJarPath: {
    type: 'string',
    title: 'Velocity Validator Jar Path',
    description: 'Velocity Validator Jar Path, can be obtained from here.',
    default: '',
    order: 20
  },
  RepoPath: {
  ...
  ExternalJarList: {
    type: 'string',
    title: 'External Jars filenames list, semi-colon delimited',
